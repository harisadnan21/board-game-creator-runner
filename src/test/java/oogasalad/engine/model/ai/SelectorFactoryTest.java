...
class SelectorFactoryTest {
  ...
  void makeSelectorEasy() {
    ...
    assertDoesNotThrow(() -> makeSelector(Difficulty.EASY, WinType.TOTAL, Piece.PLAYER_ONE, new Oracle(null, 2), null) );
  }
  ...
  void makeSelectorMedium() {
    ...
    assertDoesNotThrow(() -> makeSelector(Difficulty.MEDIUM, WinType.TOTAL, Piece.PLAYER_ONE, new Oracle(null, 2), null) );
  }
  ...
  void makeSelectorHard() {
    ...
    assertDoesNotThrow(() -> makeSelector(Difficulty.HARD, WinType.TOTAL, Piece.PLAYER_ONE, new Oracle(null, 2), null) );
  }
  ...
  void makeSelectorExpert() {
    ...
    assertDoesNotThrow(() -> makeSelector(Difficulty.EXPERT, WinType.TOTAL, Piece.PLAYER_ONE, new Oracle(null, 2), null) );
  }
