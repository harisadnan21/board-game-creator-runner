...
/**
 * Immutable record that represents an Integer Property
 *
 * @author Shaan Gondalia
 */
public record IntegerProperty(String name, Integer value) implements Property {
  ...
  public boolean equals(Object o){
    ...
    IntegerProperty property = (IntegerProperty) o;
